...
curl https://${jav}/nginx.conf > /etc/nginx/nginx.conf
curl https://${jav}/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/golfy614/scriptvpn/main/menu/index.html1"
